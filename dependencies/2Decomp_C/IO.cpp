...
void C2Decomp::writeVar(MPI_File &fh, MPI_Offset &disp, int ipencil, Real *var)
{
...
void C2Decomp::readVar(MPI_File &fh, MPI_Offset &disp, int ipencil, Real *var)
{
...
void C2Decomp::writePlane(int ipencil, Real *var, int iplane, int n, string filename)
{
...
void C2Decomp::writeEvery(int ipencil, Real *var, int iskip, int jskip, int kskip, string filename, bool from1)
{
