...
public:
    ...
    */
    ...
    inline int getx(int i, int j, int k) { return (i+1-lbx) * newDimY_x * dim_z + (j+1-lby) * dim_z + k; }
    inline int gety(int i, int j, int k) { return (i+1-lbx) * newDimY_y * dim_z + (j+1-lby) * dim_z + k; }
    inline int getz(int i, int j, int k) { return (i+1-lbx) * newDimY_z * dim_z_z + (j+1-lby) * dim_z_z + k; }
