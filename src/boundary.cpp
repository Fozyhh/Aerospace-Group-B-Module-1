...
void boundary::addFunction(size_t direction, std::unique_ptr<BoundaryFunction> x){
    switch(direction){
        case 0:
            boundary_value_u.push_back(std::move(x));
            break;
        case 1:
            boundary_value_v.push_back(std::move(x));
            break;
        case 2:
            boundary_value_w.push_back(std::move(x));
            break;
    }
};
